    ...
    useEffect(() => {
        (async () => {
            ...
            productsDiscounted.sort((previous, next) => {
                return (
                    previous.discount.percent_off - next.discount.percent_off
                );
            });
            ...
            setProductsDiscounted(
                productsDiscounted.slice(productsDiscounted.length % 4)
            );
        })();
    }, [currency.state]);
            ...
            <main className="d-flex flex-column">
                                ...
                                <>
                                    ...
                                    >
                                        ...
                                        {specialOffer.discount &&
                                            specialOffer.discount.percent_off}
                                        %
                                    </div>
                        ...
                        {specialOffer.id && (
                            <>
                                ...
                                <Button
                                    ...
                                    onClick={() => addToCart(specialOffer)}
                                >
                ...
                <div className="main my-2 d-flex w-100 justify-content-between flex-wrap">
                    <ProductsListComplex
                        {...props}
                        data={
                            productsDiscounted.length
                                ? productsDiscounted
                                : props.productsDiscounted
                        }
                    />
                </div>
            </main>
